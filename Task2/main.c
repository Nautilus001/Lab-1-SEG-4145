...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
uint8_t dataTask1[] = "Task1\r\n";
uint8_t dataTask2[] = "Task2\r\n";
...
void StartTask2(void *argument)
{
  ...
  for(;;)
  {
	  ...
	  */
	  ...
	  //GREEN and PedestrianRED FOREVER
  ...
  for(;;)
  {
	  ...
	  */
	  ...
	  if(flag){
		  ...
		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_3, GPIO_PIN_SET); //red on
		  osDelay(1000);
		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_10, GPIO_PIN_RESET); //ped red off
		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6, GPIO_PIN_SET); //ped blue on
		  osDelay(10000);
		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_6, GPIO_PIN_RESET); //ped blue off
		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_10, GPIO_PIN_SET); //ped red on
		  osDelay(1000);
		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_5, GPIO_PIN_SET); //yellow on
		  osDelay(2000);
		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_5, GPIO_PIN_RESET); //yellow off
		  HAL_GPIO_WritePin(GPIOB, GPIO_PIN_3, GPIO_PIN_RESET); // red off
